...
# input_file = './data_201901/AcDay'
# output_file = './data_201901/2019.csv'
# allFile_list = glob.glob(os.path.join(input_file,'Ac_Day_2019*'))
...
# print('2019.csv 저장완료')
# df = pd.read_csv('data_201901/2019.csv', encoding='ISO-8859-1')
# print(df.shape)
# print(df)
...
# df.to_csv('./반올림전.csv', header=False, index=False)
# print('반올림전.csv 저장 완료')

#========================================================================
#================================test파트================================
#========================================================================

df = pd.read_csv('./반올림전.csv',
