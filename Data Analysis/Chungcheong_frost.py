...
m = folium.Map(location=[36.592866, 127.3545505], zoom_start=9)
...
m.save('Chungcheong_frost.html')

#======================== 상위 5개 결빙 구간 길이 sorting ========================
condition_area = df1.시작주소.str.contains('충남') | df1.시작주소.str.contains('충북')
