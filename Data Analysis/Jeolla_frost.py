...
m = folium.Map(location=[35.2680525, 127.018649], zoom_start=9)

kr_distinct_geojson = 'https://raw.githubusercontent.com/onewool/traffico/main/Data%20Analysis/data/geojson/%EC%A0%84%EB%9D%BC%EB%8F%84.json'
print('json파일 불러옴')
...
m.save('Jeolla_frost.html')

#======================== 상위 5개 결빙 구간 길이 sorting ========================
condition_area = df1.시작주소.str.contains('전남') | df1.시작주소.str.contains('전북')
